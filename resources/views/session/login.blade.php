              ...
              <div class="card card-plain mt-8">
                ...
                <div class="card-body">
                  <form role="form" method="POST" action="/login" id="login_form">
                    ...
                    <div class="mb-3">
                      <input type="text" class="form-control" name="mobile" id="mobile" placeholder="{{__('message.mobile')}}" value="" style="direction: ltr;">
                      @error('mobile')
                    ...
                    <div class="mb-3">
                      <input type="password" class="form-control" name="password" id="password" placeholder="{{__('message.password')}}" value="" style="direction: ltr;">
                      @error('password')
                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                      @enderror
                    </div>
                    ...
                    <div class="text-center">
                      <button type="submit" class="btn bg-gradient-info w-100 mt-4 mb-0" id="submit_button">{{ __('message.sign_in') }}</button>
                    </div>
                  </form>
                </div>
