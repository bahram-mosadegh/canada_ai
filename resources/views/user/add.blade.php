    ...
    <div class="card-body pt-4 p-3">
        <form action="/add_user" method="POST" role="form text-left">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="password" class="form-control-label required">{{ __('message.password') }}</label>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="role" class="form-control-label required">{{ __('message.role') }}</label>
                        <select required class="form-control" name="role" id="role">
                            <option value="">-- {{__('message.select')}} --</option>
                            <option value="admin" @selected(old('role') == 'admin')>{{__('message.admin')}}</option>
                            <option value="user" @selected(old('role') == 'user')>{{__('message.user')}}</option>
                        </select>
                        @error('role')
                            <p class="text-danger text-xs mt-2">{{ $message }}</p>
                        @enderror
